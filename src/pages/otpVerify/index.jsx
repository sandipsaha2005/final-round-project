...
import { useOtpVerifyMutation, useResendOtpMutation } from '@/redux/slices/auth';
...
export function Component() {
	...
	const [otpVerify, { data, isLoading, isSuccess }] = useOtpVerifyMutation();
	...
	const handelSubmit = async () => {
		try {
			...
			if (res?.data?.data?.token) {
				...
				navigate(`/${import.meta.env.VITE_SUBFOLDER_NAME}/registration-success`);
			} else {
